...
Default model: `nvidia/llama-3.3-nemotron-super-49b-v1.5` (NVIDIA-native, agentic/tool-calling
optimized). Alternatives in the menu: `mistralai/mistral-nemotron` (agentic workflows),
`nvidia/nemotron-3-super-120b-a12b` (120B MoE), `nvidia/llama-3.1-nemotron-ultra-253b-v1` (highest
accuracy), `meta/llama-3.3-70b-instruct` (reliable tool calls), `deepseek-ai/deepseek-v4-flash`,
and `nvidia/llama-3.1-nemotron-nano-8b-v1` (fast/cheap). Browse 100+ models at build.nvidia.com.
...
`nvidia/llama-3.3-nemotron-super-49b-v1.5` (NVIDIA-native, agentic); override with `HERMES_NIM_MODEL`
or pass a model id as the 2nd arg (e.g. `hermes-switch nim mistralai/mistral-nemotron`). 1M context is native to Opus 4.8 / Sonnet 4.6 — no
